...
- worktree root (your cwd): /Users/khaklidelborai/orca/workspaces/gilt/p7-28-export
- branch: refs/heads/khalidelborai/p7-28-export
...
/Users/khaklidelborai/orca/workspaces/gilt/live-pause-resume/.orca-fanout/plan-7.28-export.md
...
orca orchestration task-update --id task_3bc6bde08f81 --status completed --result '{"head":"<final HEAD sha>","summary":"<2-3 sentences>","concerns":"<deviations/blockers or none>"}' --json

If you are blocked and cannot proceed, set status blocked instead and stop:
orca orchestration task-update --id task_3bc6bde08f81 --status blocked --result '{"reason":"...","at_task":"<n>"}' --json
