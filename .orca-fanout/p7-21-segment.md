...
- worktree root (your cwd): /Users/khaklidelborai/orca/workspaces/gilt/p7-21-segment
- branch: refs/heads/khalidelborai/p7-21-segment
...
/Users/khaklidelborai/orca/workspaces/gilt/live-pause-resume/.orca-fanout/plan-7.21-segment.md
...
orca orchestration task-update --id task_b78e033191af --status completed --result '{"head":"<final HEAD sha>","summary":"<2-3 sentences>","concerns":"<deviations/blockers or none>"}' --json

If you are blocked and cannot proceed, set status blocked instead and stop:
orca orchestration task-update --id task_b78e033191af --status blocked --result '{"reason":"...","at_task":"<n>"}' --json
