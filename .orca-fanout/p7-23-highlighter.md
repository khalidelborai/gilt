...
- worktree root (your cwd): /Users/khaklidelborai/orca/workspaces/gilt/p7-23-highlighter
- branch: refs/heads/khalidelborai/p7-23-highlighter
...
/Users/khaklidelborai/orca/workspaces/gilt/live-pause-resume/.orca-fanout/plan-7.23-highlighter.md
...
orca orchestration task-update --id task_928d0da43747 --status completed --result '{"head":"<final HEAD sha>","summary":"<2-3 sentences>","concerns":"<deviations/blockers or none>"}' --json

If you are blocked and cannot proceed, set status blocked instead and stop:
orca orchestration task-update --id task_928d0da43747 --status blocked --result '{"reason":"...","at_task":"<n>"}' --json
