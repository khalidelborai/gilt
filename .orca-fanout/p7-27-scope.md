...
- worktree root (your cwd): /Users/khaklidelborai/orca/workspaces/gilt/p7-27-scope
- branch: refs/heads/khalidelborai/p7-27-scope
...
/Users/khaklidelborai/orca/workspaces/gilt/live-pause-resume/.orca-fanout/plan-7.27-scope.md
...
orca orchestration task-update --id task_6142f44eabd9 --status completed --result '{"head":"<final HEAD sha>","summary":"<2-3 sentences>","concerns":"<deviations/blockers or none>"}' --json

If you are blocked and cannot proceed, set status blocked instead and stop:
orca orchestration task-update --id task_6142f44eabd9 --status blocked --result '{"reason":"...","at_task":"<n>"}' --json
