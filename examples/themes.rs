...
fn main() {
    ...
    print_theme("Monokai", Theme::monokai(), &[
    ...
    print_theme("Solarized Dark", Theme::solarized_dark(), &[
    ...
    print_theme("Solarized Light", Theme::solarized_light(), &[
    ...
    print_theme("Dracula", Theme::dracula(), &[
    ...
    print_theme("One Dark", Theme::one_dark(), &[
    ...
    print_theme("GitHub Dark", Theme::github_dark(), &[
    ...
    print_theme("GitHub Light", Theme::github_light(), &[
